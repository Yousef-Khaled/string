...
//functions
	...
	mstring& replace(const mstring& , const mstring&); // lsaaaaaaaaaaa
	void reverse();
	void reversewords();
	int countwords();
	void sortwords();
	static void sortwords(mstring arr[] , int);
	void display ();
	void align(Choice c);	//lsaaaaaaaaaaaa
};
#endif /* MSTING_H_ */
